#!/usr/bin/env python3
"""Package a validated atlas as a local Zo pet asset."""
...
def main() -> None:
    ...
    parser.add_argument("--zo-pets-home", default=str(default_zo_pets_home()))
    parser.add_argument(
        "--output-dir",
    ...
    target_dir = (
        ...
        if args.output_dir
        else Path(args.zo_pets_home).expanduser().resolve() / pet_id
    )
