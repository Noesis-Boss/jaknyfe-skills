...
import { isRetryableError, isPaymentRequiredError, isModelNotFoundError, isModelAccessForbiddenError, timingSafeStringEqual, extractApiToken, getRequestGroupId, getStickyModel, setStickyModel, traceRouteEvent, logRequest, } from './proxy.js';
    ...
    for (let attempt = 0; attempt < MAX_RETRIES; attempt++) {
        ...
        try {
            ...
            if (stream) {
                ...
                const gen = route.provider.streamChatCompletion(route.apiKey, messages, route.modelId, completionOpts, quotaContextForRoute(route, 'responses'));
                ...
                const result = await route.provider.chatCompletion(route.apiKey, messages, route.modelId, completionOpts, quotaContextForRoute(route, 'responses'));
