 ...
 */
export declare function applyCatalog(db: DatabaseType.Database, catalog: Catalog): NonNullable<SyncResult['counts']>;
/**
...
export declare function startCatalogSync(): void;
