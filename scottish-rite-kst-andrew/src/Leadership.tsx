...
const officers = [
  ...
  { rank: 'Senior Warden', name: 'Sir Knight Michael Grzegorski, 32° KSA' },
  { rank: 'Junior Warden', name: 'Sir Knight Michael Kofta, 32° KSA' },
  { rank: 'Treasurer/Secretary', name: 'Ill. Sir Knight Brian Pilz, 33° KSA' },
