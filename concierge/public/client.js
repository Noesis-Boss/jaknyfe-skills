...
function App() {
  ...
  const [joinStatus, setJoinStatus] = import_react.useState("");
  async function ask() {
    if (!q.trim())
      return;
    setBusy(true);
  ...
  async function joinChannel() {
    ...
    const channelId = document.getElementById("chanId").value;
    if (!channelId.trim()) {
      setJoinStatus("Enter a channel/group ID.");
      return;
    }
  ...
  return /* @__PURE__ */ jsx_dev_runtime.jsxDEV("main", {
    ...
    children: [
      /* @__PURE__ */ jsx_dev_runtime.jsxDEV("h1", {
        children: "\uD83D\uDECE️ Concierge"
      }, undefined, false, undefined, this),
      /* @__PURE__ */ jsx_dev_runtime.jsxDEV("p", {
        className: "sub",
        children: "Your trip companion · Phoenix ➜ Houston ➜ Cancún"
      }, undefined, false, undefined, this),
      /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx_dev_runtime.jsxDEV("button", {
            onClick: ask,
            disabled: busy,
            children: busy ? "Thinking…" : "Ask Concierge"
          }, undefined, false, undefined, this)
        ]
      }, undefined, true, undefined, this),
      reply && /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
        className: "reply",
        children: reply
      }, undefined, false, undefined, this),
      /* @__PURE__ */ jsx_dev_runtime.jsxDEV("details", {
        className: "joinbox",
        children: [
          /* @__PURE__ */ jsx_dev_runtime.jsxDEV("summary", {
            children: "Add Concierge to a group channel"
          }, undefined, false, undefined, this),
          /* @__PURE__ */ jsx_dev_runtime.jsxDEV("p", {
            className: "hint",
            children: "Share this with the other 25 travelers — they can invite the bot to their Telegram / Slack / Discord group."
          }, undefined, false, undefined, this),
          /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
            className: "row",
            children: [
          ...
          joinStatus && /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
            className: "reply",
            children: joinStatus
          }, undefined, false, undefined, this)
        ]
